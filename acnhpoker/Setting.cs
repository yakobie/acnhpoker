...
namespace ACNHPoker
{
    public partial class Setting : Form
    {
        ...
        public void overrideAddresses()
        {
            ...
            this.Critter.Text = Config.AppSettings.Settings["Critter"].Value;
            ...
            if (Utilities.InsectAppearPointer != Convert.ToUInt32(Critter.Text, 16))
                Critter.ForeColor = Color.Red;
            ...
            ConfigValue.Add("Critter", Convert.ToUInt32(Critter.Text, 16));
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            Config.AppSettings.Settings["Critter"].Value = this.Critter.Text;
